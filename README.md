...
through a bit of a design process and produce a consensus among the simple-lang
core team.

The "RFC" (request for comments) process is intended to provide a
consistent and controlled path for new features to enter the framework.

[Active RFC List](https://github.com/simple-lang/rfcs/pulls)

## When you need to follow this process

You need to follow this process if you intend to make "substantial"
changes to simple-lang, simple-lang Data or its documentation. What constitutes a
...
include the following.
   ...
   - The introduction of new idiomatic usage or conventions, even if they
     do not include code changes to simple-lang itself.
...
criteria (speedup, better browser support)
   - Additions only likely to be _noticed by_ other implementors-of-simple-lang,
invisible to users-of-simple-lang.
...
In short, to get a major feature added to simple-lang, one must first get the
RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into simple-lang.

* Fork the RFC repo http://github.com/simple-lang/rfcs
...
and comments have been made summarizing the rationale for rejection. A msimple-lang of
...
member simple-lang will merge the RFC's associated pull request, at which point the RFC will
become 'active'.

## The RFC life-cycle

Once an RFC becomes active then authors may implement it and submit the
feature as a pull request to the simple-lang repo. Becoming 'active' is not a rubber
...
**simple-lang's RFC process owes its inspiration to the [Rust RFC process, ReactJS RFC process, and Ember's RFC]**
